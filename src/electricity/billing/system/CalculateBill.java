    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            try {
                ...
                while(rs.next()) {
                    totalbill += unit_consumed * Double.parseDouble(rs.getString("cost_per_unit"));
                    totalbill += Double.parseDouble(rs.getString("meter_rent"));
                    totalbill += Double.parseDouble(rs.getString("service_charge"));
                    totalbill += Double.parseDouble(rs.getString("swacch_bharat_tax"));
                    totalbill += Double.parseDouble(rs.getString("fixed_tax"));
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
